...
To keep adding contacts to a Goal created in CALL-E Web under its reviewed call strategy, see [Goal Contacts](/goal-contacts). Contact enrollment does not require a published Goal Run interface.
