---
title: Goal Runs
description: Run a published Goal with one phone number and schema-validated variables.
---
...
| `Authorization` | Header | Yes | API key for the owning account. A missing, cross-owner, or mismatched resource returns `404`. |
