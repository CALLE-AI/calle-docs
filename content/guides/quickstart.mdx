...
<span className="doc-badge">API key</span>
<span className="doc-badge">TypeScript</span>
<span className="doc-badge">Python</span>
...
See [Authentication](#/authentication) for API key handling, server-only usage, and webhook secret boundaries.
...
<h2 id="minimum-request">Minimum request</h2>
...
<h2 id="create-and-wait">Create and wait</h2>
