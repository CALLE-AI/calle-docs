...
The Dashboard now includes Call Records for reviewing task history,
conversations, and call audio recordings.

### SDK and API integration examples

The Dashboard now includes SDK and API integration examples and can display the
...
### Session recovery and clearer task status

The Dashboard restores messages, progress, drafts, user-facing reasoning
...
Messages, interaction answers, reauthorization, and Stop requests can be
...
Fixed issues that could lose or stall accepted tasks, duplicate messages or
