...
Default-line task capacity is shared across API, MCP, and Dashboard. Account concurrency and token-budget denials have distinct 429 codes; unavailable controls return distinct 503 codes. Calls API idempotent retries preserve the original creation error.
