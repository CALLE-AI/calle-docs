...
**Updated billing model:** Model Fee is **$0.0296 per 10 seconds** for One-shot-call
and **$0.0148 per 10 seconds** for Goal. US / CA domestic outbound Carrier Fee is
**$0.0400/min** and **$0.0200/min**, respectively, rounded up to whole minutes;
international charges follow carrier rates and billing increments.

**Half-price calling with Goal:** A 30-second US / CA domestic outbound call costs
**$0.1288 with One-shot-call** or **$0.0644 with Goal**, excluding preparation usage.
Choose Goal for batch and large-scale calling.

**Billing guide:** See [Billing](/billing) for the interactive cost breakdown and
more examples. Preparation may incur model fees even without a connection; the
experimental Task Success Fee remains fully waived.

All prices are in USD.

## 2026-09-23 — Calls & SDK 1.0

**Calls and SDK 1.0:** Single-target Calls are available through the production API and the TypeScript
